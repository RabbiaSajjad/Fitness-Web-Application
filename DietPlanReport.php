...
<head>
        <meta charset="UTF-8">
        <title>
            Diet Plan Report - Fit-Me Application
        </title>
        <link rel="stylesheet" href="style1.css">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>
  <body>  Diet Plan Report
...
<?php  // creating a database connection 
   ...
   {  die('Could not connect to Oracle: '); 
    ...
    $sql_select1 = "select * from dietplan";
    ...
    if ($runselect && $runselect1) 
    {
           while($row = oci_fetch_array($query_id3, OCI_BOTH+OCI_RETURN_NULLS)) 
           {
            ...
            $row1=oci_fetch_array($query_id4, OCI_BOTH+OCI_RETURN_NULLS);
               ...
               echo "<tr align = middle>"."<td>"."Calories Intake"."</td>"."<td>".$r3."</td>"."</tr>";
               echo "<tr align = middle>"."<td>"."Proteins Intake"."</td>"."<td>".$r4."</td>"."</tr>";
               echo "</table>";
               echo "<br><br>";
            } 
        }
